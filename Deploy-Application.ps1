...
Try {
	...
	[string]$appVersion = '2022.2.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/28/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-Process -Path "$dirFiles\TableauDesktop-64bit-2022-2-0.exe" -Parameters "ACCEPTEULA=1 AUTOUPDATE=1 DATABASEDRIVERS=1 DESKTOPSHORTCUT=1 REMOVEINSTALLEDAPP=1 /quiet /norestart" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Write-Log -Message "Attempting to run uninstaller..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "$dirFiles\TableauDesktop-64bit-2022-2-0.exe" -Parameters "/uninstall /quiet" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUSmKeA31PutPk9WM389xrX2TZ
# PWOgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFI3KLx2+gCh9TAbiWhB2ucDwJNMeMA0GCSqGSIb3DQEBAQUABIIBgF53Bs/v
# 2jVDrrxwUylSAEKsgG6yxmvk5387KRpXDdrwmzyYV9c8FiUdf1h03OLYLTSUfsdT
# w7gmAozeMVtxK6qeKLya9vqalTn7kPa4Fy7CbPGnROYXuTvaomaU+geWLH8N6pvN
# KZ29E+LtlClCzF1b2m4wyygJ13Y7YPU89YxtOH88ne/ftaU2blqvthmtW/TmzI68
# WhKFD3+0rlze7BfxiH2gRtKyTDF70ST7ZDalrtYZ7aOH2WpcdEyzlKB2OK5I3X45
# xSHEl1N427l9ajtiCmxjzogVGGwX/Utx1+ikOZ3zmftqOMgd5yZLykTO4tKeY4pu
# otfWGQVxvBejQ+wueN0E4+Me7MSdRpBcC5avd0iiESQi/Aqx6/1eZn1aijXLJAFe
# Psf5wXNzYZDD4EOwV2FFqwu3NUMBFVY35J40MYCyqhB+//exiRaWxTbgNz/OsgzT
# EvAIYLNUWWiCbmkpBWXvAKu+fDbC07gyBCuHAigPfjQGen6uFL+if+hK4A==
